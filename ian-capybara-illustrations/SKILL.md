---
name: ian-capybara-illustrations
description: 生成 Ian 风格的中文正文配图。用于用户要求为中文文章、帖子、博客、Notion 文档、工作流文档、方法论、流程、结构、状态、隐喻或观点生成“怪诞”“卡皮巴拉”“水豚”“手绘”“正文配图”“文章插图”“配图建议”“shot list”“去标题/改图”等任务；默认使用卡皮巴拉 IP、纯白手绘、少量红橙蓝批注、简洁清爽但天马行空的视觉风格。
---
...
默认视觉 IP 是“卡皮巴拉”：暖棕色圆墩身体、粗黑手绘外轮廓、小圆耳、短腿、豆点眼或背面空表情，认真做一件荒诞但成立的事。卡皮巴拉必须参与画面的核心动作，不能只是站在旁边当装饰。
...
- `references/capybara-ip.md`：卡皮巴拉 IP 的形象、性格、动作库和禁忌。
...
- `assets/capybara-reference.png`：卡皮巴拉 IP 的低频视觉参考，只用于校准圆墩身体、粗黑轮廓、小耳朵、短腿和呆滞状态，不要复刻原图姿势或构图。
...
不要复刻过往案例。案例只提供风格密度和卡皮巴拉参与方式，不能直接复用“传送带断点 / 卡皮巴拉拉线 / 素材鱼 / 盖章工具箱 / 常见坑路径”等已有构图，除非用户明确要求复刻某张图。每次都要从当前文章重新发明一个奇怪但成立的隐喻。
