...
画法：左侧输入，中间卡皮巴拉或怪机器处理，右侧输出，橙色箭头表达主流向。

### 系统局部

适合：信息来源、过滤器、数据库、渲染器、agent 系统局部。

画法：只画 3-5 个核心模块，卡皮巴拉参与其中一个关键动作。
...
画法：一层层盒子，不要正式金字塔；卡皮巴拉在旁边搬砖或搭建。

### 地图路线

适合：从想法到上线、用户路径、内容承接路径、学习路线。

画法：一条弯曲路径，少量节点，卡皮巴拉牵线或走路。
...
3. 让卡皮巴拉承担动作：不是站旁边，而是卡在机器里、用身体堵住洞、拉错线、守门、搬运、修补、称重、扶梯子、记录、把东西塞进某个怪装置。
...
- 拉、扛、塞、捞、压、称、缝、剪、拧、守、推、接、拆、标记、回收、趴住、堵住、驮着、慢慢推。
- 动作要服务核心意思，不要为了怪而怪。
...
同类主题也要换新隐喻。例如“承接路径”不一定画路线，可以画卡皮巴拉把内容尾巴接到门把手；“一鱼多吃”不一定画鱼，可以画卡皮巴拉把一个纸团压成几种形状。
